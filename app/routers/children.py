...
from app.services.ai_service import face_embedding_service
...
def create_child(
    ...
    if photo_path:
        try:
            face_embedding_service.initialize()
            embedding = face_embedding_service.extract_face_embedding(photo_path)
